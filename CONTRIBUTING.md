...
For transparency, any real or potential conflict of interest must be declared opening an *issue* with the `conflict-of-interest` label.
The committee will assess the situation and decide on appropriate measures (e.g. abstaining from a vote). Please read the Retraceur [conflict of interest policy](./CONFLICT_OF_INTEREST.md) for more information about it.
